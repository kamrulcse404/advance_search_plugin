<?php
class Road_Map extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Road Map', 'elementor-addon');
    }
...
?>
        ...
        <div id="wrapper" class="wrapper-style">
            <div id="page" class="clearfix">
                ...
                <section class="section-roadmap section-bg-1">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tf-roadmap-style-thumb">
                                                ...
                                                <div class="content-rm-thumb">
                                                    <div class="content-left">
                                                        <div class="thumb-left">
                                                            <img src="https://developersaiful.com/Orion/wp-content/uploads/2024/01/rm-1.jpg" alt="images" />
                                                        </div>
                                                        <div class="thumb-right">
                                                            <div class="top">
                                                                <img src="https://developersaiful.com/Orion/wp-content/uploads/2024/01/rm-3.jpg" alt="images" />
                                                            </div>
                                                            <div class="bottom">
                                                                <img src="https://developersaiful.com/Orion/wp-content/uploads/2024/01/rm-2.jpg" alt="images" />
                                                            </div>
                                                        </div>
                                                    </div>
